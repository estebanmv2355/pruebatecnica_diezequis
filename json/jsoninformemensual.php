...
$columns = array(
   ...
   array( 'db' => '"'.$aprueba.'"',  'dt' => 'APRUEBA', 'field' => 'APRUEBA', 'as' => 'APRUEBA' ),//11
	...
	array( 'db' => 'ca.caa_clave_int', 'dt' => 'APROBAR', 'field' => 'caa_clave_int', 'formatter' => function($d, $row){
		...
		{
			return '<img style="cursor:pointer" src="../../images/aprobar.png" title="Aprobar" onclick=APROBARCOMITE('.$row[1].',"INFORMEMENSUAL") height="30" width="29">';
		}					
	}),
	array( 'db' => 'ca.caa_clave_int', 'dt' => 'ELIMINAR', 'field' => 'caa_clave_int', 'formatter' => function($d, $row){
		if(($row[9] == '1' and strtoupper($row[10]) == strtoupper('Administrador')) or ($row[9] == '0'))
		{
			return '<img style="cursor:pointer" src="../../images/delete.png" height="30" width="29" title="ELIMINAR" onclick=ELIMINARARCHIVO('.$row[1].',"INFORMEMENSUAL") >';
		}					
	})
);
...
if($listaobras <> '')
{
	if($nomane <> '')
	{
		...
		{
			$extraWhere = "ca.obr_clave_int in (select obr_clave_int from usuario_obra where usu_clave_int = ".$claveusuario.") and ca.tii_clave_int = 4 and ca.obr_clave_int in (".$listaobras.") and (ca.caa_nombre LIKE REPLACE('%".$nomarc."%',' ','%') OR '".$nomarc."' IS NULL OR '".$nomarc."' = '') and ca.caa_clave_int in (select caa_clave_int from anexos_archivo where ana_nombre LIKE REPLACE('%".$nomane."%',' ','%') OR '".$nomane."' IS NULL OR '".$nomane."' = '') and (ca.caa_comentarios LIKE REPLACE('%".$nomcom."%',' ','%') OR '".$nomcom."' IS NULL OR '".$nomcom."' = '')";
		}
		else
		if($ultimoestado == "PENDIENTES")
		{
			$extraWhere = "ca.obr_clave_int in (select obr_clave_int from usuario_obra where usu_clave_int = ".$claveusuario.") and ca.caa_estado = 0 and ca.tii_clave_int = 4 and ca.obr_clave_int in (".$listaobras.") and (ca.caa_nombre LIKE REPLACE('%".$nomarc."%',' ','%') OR '".$nomarc."' IS NULL OR '".$nomarc."' = '') and ca.caa_clave_int in (select caa_clave_int from anexos_archivo where ana_nombre LIKE REPLACE('%".$nomane."%',' ','%') OR '".$nomane."' IS NULL OR '".$nomane."' = '') and (ca.caa_comentarios LIKE REPLACE('%".$nomcom."%',' ','%') OR '".$nomcom."' IS NULL OR '".$nomcom."' = '')";
		}
		else
		if($ultimoestado == "APROBADOS")
		{
			$extraWhere = "ca.obr_clave_int in (select obr_clave_int from usuario_obra where usu_clave_int = ".$claveusuario.") and ca.caa_estado = 1 and ca.tii_clave_int = 4 and ca.obr_clave_int in (".$listaobras.") and (ca.caa_nombre LIKE REPLACE('%".$nomarc."%',' ','%') OR '".$nomarc."' IS NULL OR '".$nomarc."' = '') and ca.caa_clave_int in (select caa_clave_int from anexos_archivo where ana_nombre LIKE REPLACE('%".$nomane."%',' ','%') OR '".$nomane."' IS NULL OR '".$nomane."' = '') and (ca.caa_comentarios LIKE REPLACE('%".$nomcom."%',' ','%') OR '".$nomcom."' IS NULL OR '".$nomcom."' = '')";
		}
	}
	else
	{
		if($ultimoestado == "TODOS")
		{
			$extraWhere = "ca.obr_clave_int in (select obr_clave_int from usuario_obra where usu_clave_int = ".$claveusuario.") and ca.tii_clave_int = 4 and ca.obr_clave_int in (".$listaobras.") and (ca.caa_nombre LIKE REPLACE('%".$nomarc."%',' ','%') OR '".$nomarc."' IS NULL OR '".$nomarc."' = '') and (ca.caa_comentarios LIKE REPLACE('%".$nomcom."%',' ','%') OR '".$nomcom."' IS NULL OR '".$nomcom."' = '')";
		}
		else
		if($ultimoestado == "PENDIENTES")
		{
			$extraWhere = "ca.obr_clave_int in (select obr_clave_int from usuario_obra where usu_clave_int = ".$claveusuario.") and ca.caa_estado = 0 and ca.tii_clave_int = 4 and ca.obr_clave_int in (".$listaobras.") and (ca.caa_nombre LIKE REPLACE('%".$nomarc."%',' ','%') OR '".$nomarc."' IS NULL OR '".$nomarc."' = '') and (ca.caa_comentarios LIKE REPLACE('%".$nomcom."%',' ','%') OR '".$nomcom."' IS NULL OR '".$nomcom."' = '')";
		}
		else
		if($ultimoestado == "APROBADOS")
		{
			$extraWhere = "ca.obr_clave_int in (select obr_clave_int from usuario_obra where usu_clave_int = ".$claveusuario.") and ca.caa_estado = 1 and ca.tii_clave_int = 4 and ca.obr_clave_int in (".$listaobras.") and (ca.caa_nombre LIKE REPLACE('%".$nomarc."%',' ','%') OR '".$nomarc."' IS NULL OR '".$nomarc."' = '') and (ca.caa_comentarios LIKE REPLACE('%".$nomcom."%',' ','%') OR '".$nomcom."' IS NULL OR '".$nomcom."' = '')";
		}
	}
}
else
{
	if($nomane <> '')
	{
		if($ultimoestado == "TODOS")
		{
			$extraWhere = "ca.obr_clave_int in (select obr_clave_int from usuario_obra where usu_clave_int = ".$claveusuario.") and ca.tii_clave_int = 4 and (ca.caa_nombre LIKE REPLACE('%".$nomarc."%',' ','%') OR '".$nomarc."' IS NULL OR '".$nomarc."' = '') and ca.caa_clave_int in (select caa_clave_int from anexos_archivo where ana_nombre LIKE REPLACE('%".$nomane."%',' ','%') OR '".$nomane."' IS NULL OR '".$nomane."' = '') and (ca.caa_comentarios LIKE REPLACE('%".$nomcom."%',' ','%') OR '".$nomcom."' IS NULL OR '".$nomcom."' = '') and o.obr_clave_int = '".$ultimaobra."'";
		}
		else
		if($ultimoestado == "PENDIENTES")
		{
			$extraWhere = "ca.obr_clave_int in (select obr_clave_int from usuario_obra where usu_clave_int = ".$claveusuario.") and ca.caa_estado = 0 and ca.tii_clave_int = 4 and (ca.caa_nombre LIKE REPLACE('%".$nomarc."%',' ','%') OR '".$nomarc."' IS NULL OR '".$nomarc."' = '') and ca.caa_clave_int in (select caa_clave_int from anexos_archivo where ana_nombre LIKE REPLACE('%".$nomane."%',' ','%') OR '".$nomane."' IS NULL OR '".$nomane."' = '') and (ca.caa_comentarios LIKE REPLACE('%".$nomcom."%',' ','%') OR '".$nomcom."' IS NULL OR '".$nomcom."' = '') and o.obr_clave_int = '".$ultimaobra."'";
		}
		else
		if($ultimoestado == "APROBADOS")
		{
			$extraWhere = "ca.obr_clave_int in (select obr_clave_int from usuario_obra where usu_clave_int = ".$claveusuario.") and ca.caa_estado = 1 and ca.tii_clave_int = 4 and (ca.caa_nombre LIKE REPLACE('%".$nomarc."%',' ','%') OR '".$nomarc."' IS NULL OR '".$nomarc."' = '') and ca.caa_clave_int in (select caa_clave_int from anexos_archivo where ana_nombre LIKE REPLACE('%".$nomane."%',' ','%') OR '".$nomane."' IS NULL OR '".$nomane."' = '') and (ca.caa_comentarios LIKE REPLACE('%".$nomcom."%',' ','%') OR '".$nomcom."' IS NULL OR '".$nomcom."' = '') and o.obr_clave_int = '".$ultimaobra."'";
		}
	}
	else
	{
		if($ultimoestado == "TODOS")
		{
			$extraWhere = "ca.obr_clave_int in (select obr_clave_int from usuario_obra where usu_clave_int = ".$claveusuario.") and ca.tii_clave_int = 4 and (ca.caa_nombre LIKE REPLACE('%".$nomarc."%',' ','%') OR '".$nomarc."' IS NULL OR '".$nomarc."' = '') and (ca.caa_comentarios LIKE REPLACE('%".$nomcom."%',' ','%') OR '".$nomcom."' IS NULL OR '".$nomcom."' = '') and o.obr_clave_int = '".$ultimaobra."'";
		}
		else
		if($ultimoestado == "PENDIENTES")
		{
			$extraWhere = "ca.obr_clave_int in (select obr_clave_int from usuario_obra where usu_clave_int = ".$claveusuario.") and ca.caa_estado = 0 and ca.tii_clave_int = 4 and (ca.caa_nombre LIKE REPLACE('%".$nomarc."%',' ','%') OR '".$nomarc."' IS NULL OR '".$nomarc."' = '') and (ca.caa_comentarios LIKE REPLACE('%".$nomcom."%',' ','%') OR '".$nomcom."' IS NULL OR '".$nomcom."' = '') and o.obr_clave_int = '".$ultimaobra."'";
		}
		else
		if($ultimoestado == "APROBADOS")
		{
			$extraWhere = "ca.obr_clave_int in (select obr_clave_int from usuario_obra where usu_clave_int = ".$claveusuario.") and ca.caa_estado = 1 and ca.tii_clave_int = 4 and (ca.caa_nombre LIKE REPLACE('%".$nomarc."%',' ','%') OR '".$nomarc."' IS NULL OR '".$nomarc."' = '') and (ca.caa_comentarios LIKE REPLACE('%".$nomcom."%',' ','%') OR '".$nomcom."' IS NULL OR '".$nomcom."' = '') and o.obr_clave_int = '".$ultimaobra."'";
		}
	}
}
